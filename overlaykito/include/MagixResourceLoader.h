...
//typedef std::pair< String, MemoryDataStream > ds;
//typedef MemoryDataStream ds;
...
protected:
	...
	//vector<ds>::type dsList;
	//DataStreamListPtr dsListPtr;
...
public:
	MagixResourceLoader() {
		...
		//dsList.clear();
		//dsListPtr = DataStreamListPtr(OGRE_NEW_T(DataStreamList, MEMCATEGORY_GENERAL)(), SPFM_DELETE_T);
	}
