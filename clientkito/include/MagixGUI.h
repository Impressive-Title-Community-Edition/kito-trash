...
#define MAX_SEXYACTIONS 18
#define MAX_ACTIONS MAX_PRIMARYACTIONS + MAX_SECONDARYACTIONS + MAX_SEXYACTIONS
...
protected:
	...
	bool isTabletFlag;
	bool isBloomFlag;
	unsigned short isShadowsOnFlag;
...
public:
	...
	void initialize(SceneManager *sceneMgr, RenderWindow *window, MagixExternalDefinitions *def, MagixGameStateManager *gameStateMgr, MagixItemManager *itemManager, MagixCritterManager *critterMgr, MagixUnitManager *unitManager, MagixNetworkManager *networkManager, MagixCamera *camera, MagixSoundManager *soundMgr, MagixEffectsManager *effectsMgr, MagixCollisionManager *collisionMgr, MagixWorld *world)
	{
		...
		mButton[BUTTON_TOOLS] = OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenButton3");
		mButtonText[BUTTON_TOOLS] = OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenButtonText3");
		...
		//ToolsScreenGUI
		mBox[GUI_TOOLSSCREENBOX] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenBox");
		mButton[BUTTON_WORLDEDITOR] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButton1");
		mButtonText[BUTTON_WORLDEDITOR] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButtonText1");
		mButton[BUTTON_SKYEDITOR] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButton2");
		mButtonText[BUTTON_SKYEDITOR] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButtonText2");
		mButton[BUTTON_TOOLSBACK] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButton4");
		mButtonText[BUTTON_TOOLSBACK] = OverlayManager::getSingleton().getOverlayElement("GUI/ToolsScreenButtonText4");

		showToolsScreenOverlay(false);
	...
	void showToolsScreenOverlay(bool flag)
	{
		if(flag)
		{
			OverlayManager::getSingleton().getByName("GUIOverlay/ToolsScreen")->show();
			mBox[GUI_TOOLSSCREENBOX]->show();
		}
		else
		{
			OverlayManager::getSingleton().getByName("GUIOverlay/ToolsScreen")->hide();
			mBox[GUI_TOOLSSCREENBOX]->hide();
		}
	}
	void buildWorldEditorOverlay()
	{
	...
	void updateTargetIndicator()
	{
		...
		if(mUnitManager->getPlayer()->getTargetAction()==TARGET_RUNTO && !mCurrentObject)
		{
			...
			const Real tScale = tDist>1000?(Ogre::Real)20: (tDist<50?(Ogre::Real)1: (1+(tDist-50)*(Ogre::Real)0.02) );
	...
	void updateCinematicBars(const FrameEvent &evt)
	{
		...
		if(cinematicBarsTimeout>0)
		{
			...
			mBackdrop->setDimensions(1.5,1 + (Ogre::Real)0.5*(cinematicBarsTimeout/2));
			mBackdrop->setPosition(-0.25,(Ogre::Real)-0.25*(cinematicBarsTimeout/2));
		}
		//fade out
		else if(cinematicBarsTimeout<0)
		{
			...
			{
				mBackdrop->setDimensions(1.5,1 + (Ogre::Real)0.5*((2+cinematicBarsTimeout)/2));
				mBackdrop->setPosition(-0.25,(Ogre::Real)-0.25*((2+cinematicBarsTimeout)/2));
			}
		}
	}
	...
	void updateHPPanel(const FrameEvent &evt)
	{
		...
		mHPBar->setWidth((Ogre::Real)0.25 * tHPRatio);
		mHPBar->setLeft((Ogre::Real)0.25*(1-tHPRatio));
	...
	void updateTargetPanel(const FrameEvent &evt)
	{
		...
		if(tTarget)
		{
			...
			mTargetHP->setWidth((Ogre::Real)(0.25 * Real(tHP)/500));
			mTargetHP->setLeft((Ogre::Real)(0.025 + 0.25*(1-Real(tHP)/500)));
	...
	void updateLogo(const FrameEvent &evt)
	{
		...
		if(mGameStateManager->getGameState()==GAMESTATE_STARTSCREEN && logoCount<=5)
		{
			...
			if(logoCount<=5)
			{
				const Real tRatio = (Ogre::Real)(1-(logoCount>5?5:logoCount)/5);
				OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenTitle")->setDimensions((Ogre::Real)(0.8+0.8*9*tRatio),(Ogre::Real)(0.12+0.12*9*tRatio));
				OverlayManager::getSingleton().getOverlayElement("GUI/StartScreenTitle")->setPosition((Ogre::Real)(0.5 - (0.8+0.8*9*tRatio)/2), (Ogre::Real)(0.25 - (0.12+0.12*9*tRatio)/2));
			}
			if(logoCount>=5)
			{
	...
	void updateEmoteBox()
	{
		...
		tList.push_back("SEXY ACTIONS:");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleCanineSlow()?"Stop Male Canine (Slow)":"Male Canine (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleCanine()?"Stop Male Canine":"Male Canine");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleCanineFast()?"Stop Male Canine (Fast)":"Male Canine (Fast)");

		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleCanineSlow()?"Stop Female Canine (Slow)":"Female Canine (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleCanine()?"Stop Female Canine":"Female Canine");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleCanineFast()?"Stop Female Canine (Fast)":"Female Canine (Fast)");

		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleFelineSlow()?"Stop Male Feline (Slow)":"Male Feline (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleFeline()?"Stop Male Feline":"Male Feline");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingMaleFelineFast()?"Stop Male Feline (Fast)":"Male Feline (Fast)");

		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleFelineSlow()?"Stop Female Feline (Slow)":"Female Feline (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleFeline()?"Stop Female Feline":"Female Feline");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleFelineFast()?"Stop Female Feline (Fast)":"Female Feline (Fast)");

		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Slow()?"Stop Female Lay (Slow)":"Female Lay (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1()?"Stop Female Lay":"Female Lay");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Fast()?"Stop Female Lay (Fast)":"Female Lay (Fast)");

		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Slow()?"Stop Female Back (Slow)":"Female Back (Slow)");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2()?"Stop Female Back":"Female Back");
		tList.push_back(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Fast()?"Stop Female Back (Fast)":"Female Back (Fast)");
		tList.push_back("");
	...
	void updateSelectPanel(const FrameEvent &evt)
	{
		if(selectPanelTimeout>0)
		{
			...
			//Grow panel
			const Real tRatio = (Ogre::Real)((0.25-selectPanelTimeout)/0.25);
			mSelectPanel->setPosition((Ogre::Real)(mSelectPanel->getLeft() + mSelectPanel->getWidth()*0.5),(Ogre::Real)(mSelectPanel->getTop() + mSelectPanel->getHeight()*0.5));
			mSelectPanel->setDimensions((Ogre::Real)(0.15*tRatio), (Ogre::Real)(0.2*tRatio));
			mSelectPanel->setPosition((Ogre::Real)(mSelectPanel->getLeft() - mSelectPanel->getWidth()*0.5),(Ogre::Real)(mSelectPanel->getTop() - mSelectPanel->getHeight()*0.5));
	...
	void updateChatBox(const FrameEvent &evt)
	{
		...
		mBoxText[GUI_TEXTOUTPUT]->setTop((Ogre::Real)((tLines - Math::IFloor(tLines))*tCharHeight + 0.008));
	}
	void updateHover()
	{
		if(mHoverWindow)
	...
	void mouseLeftDown()
	{
		...
		if(mHoverWindow)
		{
			...
			if(mHoverWindow==mBox[GUI_FRIENDBOX])	//friendbox options
			{
				...
				mBox[GUI_LISTSELECTBOX]->setDimensions(0.1,(Ogre::Real)(0.04*tNumButtons));
				mBox[GUI_LISTSELECTBOX]->setPosition((Ogre::Real)(cursorX+0.02),(Ogre::Real)(cursorY+0.02));
				mListSelectHighlight->setDimensions(mBox[GUI_FRIENDBOX]->getWidth(),0.02);
				mListSelectHighlight->setPosition(mBox[GUI_FRIENDBOX]->getLeft(),(Ogre::Real)(mBox[GUI_FRIENDBOX]->getTop()+tFontHeight*tApparentLine+0.01));
			...
			if(mHoverWindow==mBox[GUI_EMOTEBOX])	//emotebox options
			{
				Real tFontHeight = 0;
				short tApparentLine = 0;
				const short tButtonLine = getListButtonLine(GUI_EMOTEBOX,SCROLLER_EMOTEBOX,(int)mDef->emoteName.size()+MAX_ACTIONS+7,tFontHeight,tApparentLine);
				if(tButtonLine==-1 || tButtonLine>=(int)mDef->emoteName.size()+MAX_ACTIONS+7)return;
				if(tButtonLine==0 || tButtonLine==MAX_PRIMARYACTIONS+1 || tButtonLine==MAX_PRIMARYACTIONS+2)return;
				if(tButtonLine==0 || tButtonLine==(MAX_PRIMARYACTIONS+MAX_SECONDARYACTIONS+3) || tButtonLine==(MAX_PRIMARYACTIONS+MAX_SECONDARYACTIONS+4))return;
				if(tButtonLine==MAX_ACTIONS+5 || tButtonLine==MAX_ACTIONS+6)return;

				mListSelectTarget = mHoverWindow;

				//Highlight
				mListSelectHighlight->setDimensions(mBox[GUI_EMOTEBOX]->getWidth(),0.02);
				mListSelectHighlight->setPosition(mBox[GUI_EMOTEBOX]->getLeft(),(Ogre::Real)(mBox[GUI_EMOTEBOX]->getTop()+tFontHeight*tApparentLine+0.01));
				mListSelectHighlight->show();
				showListSelectBox(true);
				mBox[GUI_LISTSELECTBOX]->hide();

				if(tButtonLine<MAX_ACTIONS+7)
				{
					//Do action
					switch(tButtonLine)
					{
						...
						case 31: mUnitManager->getPlayer()->doHumpingMaleCanineSlow(!mUnitManager->getPlayer()->getIsHumpingMaleCanineSlow()); break;
						case 32: mUnitManager->getPlayer()->doHumpingMaleCanine(!mUnitManager->getPlayer()->getIsHumpingMaleCanine()); break;
						case 33: mUnitManager->getPlayer()->doHumpingMaleCanineFast(!mUnitManager->getPlayer()->getIsHumpingMaleCanineFast()); break;
						case 34: mUnitManager->getPlayer()->doHumpingFemaleCanineSlow(!mUnitManager->getPlayer()->getIsHumpingFemaleCanineSlow()); break;
						case 35: mUnitManager->getPlayer()->doHumpingFemaleCanine(!mUnitManager->getPlayer()->getIsHumpingFemaleCanine()); break;
						case 36: mUnitManager->getPlayer()->doHumpingFemaleCanineFast(!mUnitManager->getPlayer()->getIsHumpingFemaleCanineFast()); break;
						case 37: mUnitManager->getPlayer()->doHumpingMaleFelineSlow(!mUnitManager->getPlayer()->getIsHumpingMaleFelineSlow()); break;
						case 38: mUnitManager->getPlayer()->doHumpingMaleFeline(!mUnitManager->getPlayer()->getIsHumpingMaleFeline()); break;
						case 39: mUnitManager->getPlayer()->doHumpingMaleFelineFast(!mUnitManager->getPlayer()->getIsHumpingMaleFelineFast()); break;
						case 40: mUnitManager->getPlayer()->doHumpingFemaleFelineSlow(!mUnitManager->getPlayer()->getIsHumpingFemaleFelineSlow()); break;
						case 41: mUnitManager->getPlayer()->doHumpingFemaleFeline(!mUnitManager->getPlayer()->getIsHumpingFemaleFeline()); break;
						case 42: mUnitManager->getPlayer()->doHumpingFemaleFelineFast(!mUnitManager->getPlayer()->getIsHumpingFemaleFelineFast()); break;
						case 43: mUnitManager->getPlayer()->doHumpingFemaleSnuggle1Slow(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Slow()); break;
						case 44: mUnitManager->getPlayer()->doHumpingFemaleSnuggle1(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1()); break;
						case 45: mUnitManager->getPlayer()->doHumpingFemaleSnuggle1Fast(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Fast()); break;
						case 46: mUnitManager->getPlayer()->doHumpingFemaleSnuggle2Slow(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Slow()); break;
						case 47: mUnitManager->getPlayer()->doHumpingFemaleSnuggle2(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2()); break;
						case 48: mUnitManager->getPlayer()->doHumpingFemaleSnuggle2Fast(!mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Fast()); break;
					}
				}
				else
				{
					//Do emote
					const String tEmote = mDef->emoteName[tButtonLine-(MAX_ACTIONS+7)];
			...
			if(mHoverWindow==mBox[GUI_ITEMBOX])	//itembox options
			{
				...
				mListSelectHighlight->setPosition(mBox[GUI_ITEMBOX]->getLeft(),(Ogre::Real)(mBox[GUI_ITEMBOX]->getTop()+tFontHeight*tApparentLine+0.01));
				mListSelectHighlight->show();
				showListSelectBox(true);
				...
				if(listButtonData!="")
				{
					...
					mBox[GUI_LISTSELECTBOX]->setDimensions(0.1,(Ogre::Real)(0.04*(mButton[BUTTON_LISTSELECT3]->isVisible()?3:2)));
					mBox[GUI_LISTSELECTBOX]->setPosition((Ogre::Real)(cursorX+0.02),(Ogre::Real)(cursorY+0.02));
				}
			...
			if(mHoverWindow==mBox[GUI_STASHBOX])	//stashbox options
			{
				...
				mListSelectHighlight->setPosition(mBox[GUI_STASHBOX]->getLeft(),(Ogre::Real)(mBox[GUI_STASHBOX]->getTop()+tFontHeight*tApparentLine+0.01));
				mListSelectHighlight->show();
				showListSelectBox(true);
		...
		//else if(mGameStateManager->isInEditor())mWorldEditor->doInMapEditorLeftclick();
	}
	void mouseLeftUp()
	{
		...
		if(isCursorOverButton(mHoverButton))
		{
			...
			if(mHoverButton==mButton[BUTTON_TOOLS])	//tools
			{
				showStartScreenOverlay(false);
				showOptionsOverlay(false);
				showToolsScreenOverlay(true);
				return;
			}
			if(mHoverButton==mButton[BUTTON_TOOLSBACK])	//back to startscreen
			{
				showOptionsOverlay(false);
				showToolsScreenOverlay(false);
				showStartScreenOverlay(true);
			...
			if(mHoverButton==mButton[BUTTON_WORLDEDITOR])	//World Editor
			{
				showStartScreenOverlay(false);
				showOptionsOverlay(false);
				showToolsScreenOverlay(false);
				mGameStateManager->setGameState(GAMESTATE_STARTMAPEDITOR);
				return;
			}
	...
	void toggleInputMode(bool isEnter, OverlayElement *inputBox=0, String defaultCaption="Say: ", unsigned short charLimit=256, bool clearAtReturn=true, String startText="", bool allowTempStorage=true, bool allowNewLine=false, bool hideText=false)
	{
		...
		if(mInputManager->toggleInputMode())
		{
			if(mInputManager->getInputBox()==mBoxText[GUI_TEXTINPUT])
			{
				...
				if(tType == CHAT_COMMAND)
				{
					...
					else if(tParam==COMMAND_CREATEITEM && (mDef->isAdmin || ISKITO))checkItemEquippable(tCaption,true,true);
					else if(tParam==COMMAND_SPAWNITEM && (mDef->isAdmin || ISKITO))checkItemEquippable(tCaption,true,true,true);
					...
					else if(tParam==COMMAND_SPAWN && (mDef->isAdmin || ISKITO))
					{
					...
					else if(tParam==COMMAND_MASSBLOCK &&(mDef->isAdmin||mDef->isMod))
					{
						...
						if(tUnit && tUnit->isIndexedUnit())mNetworkManager->sendMassBlock((OwnerToken)static_cast<MagixIndexedUnit*>(tUnit)->getIndex());
					}
					...
					else if(tParam==COMMAND_COMMANDS)
					{
						...
						if(mDef->isAdmin)
						{
							mChatManager->message("/crooteitom [name]");
							mChatManager->message("/spoonitom [name]");
		...
		if(mInputManager->getInputBox()==OverlayManager::getSingleton().getOverlayElement("GUI/DimensionText2") && mInputManager->getInputMode()==INPUT_CONTROL)
		{
			...
			{
				if(tDimension==255&&!mDef->isMod&&!mDef->isAdmin)
				{
					mAlertBox->showAlert("Dimension 255 is reserved for testing.",0.5,0.5,2);
				}
				else
				{
	...
	void doRayPicking(bool isRightClick)
	{
        ...
        for( i = result.begin(); i != result.end(); i++ )
		{
			...
			//is world fragment -- no longer exists
		...
		// Now check for terrain clicks
		TerrainGroup::RayResult rayResult = mWorld->getTerrainGroup()->rayIntersects(mouseRay);
		if (rayResult.hit)
		{
			mUnitManager->getPlayer()->setAutoAttack(0);
			mUnitManager->getPlayer()->setTarget(rayResult.position);
			return;
		}
		//Clicked on nothing
		if(!isRightClick)
	...
	{
		if(isShadowsOnFlag==0)
		{
			isShadowsOnFlag=1;
			mButtonText[BUTTON_SETTINGS1]->setCaption("Low");
			mSceneMgr->setShadowTechnique(SHADOWTYPE_TEXTURE_MODULATIVE);
		}
		else if(isShadowsOnFlag==1)
		{
			isShadowsOnFlag=2;
			mButtonText[BUTTON_SETTINGS1]->setCaption("High");
			mSceneMgr->setShadowTechnique(SHADOWTYPE_STENCIL_MODULATIVE);
		}
		else if(isShadowsOnFlag==2)
		{
			isShadowsOnFlag=3;
			mButtonText[BUTTON_SETTINGS1]->setCaption("Test");
			mSceneMgr->setShadowTechnique(SHADOWTYPE_TEXTURE_MODULATIVE_INTEGRATED);
		}
		else 
		{
			isShadowsOnFlag=0;
			mButtonText[BUTTON_SETTINGS1]->setCaption("Off");
	...
	void showCreditsCaption(const String &caption)
	{
		...
		tCaption->setTop((Ogre::Real)(0.5-StringConverter::parseReal(tCaption->getParameter("char_height"))*int(tLines.size())/2));
	}
	...
	void setChatChannel(const unsigned char &channel)
	{
		...
		if(mChatManager->getChannel()==0)
		{
			...
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_top","1 1 0");
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_bottom","1 0.2 0.2");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_top","1 1 0");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_bottom","1 0.2 0.2");
		...
		else if(mChatManager->getChannel()==1)
		{
			...
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_top","0.9 1 0");
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_bottom","0.3 0.7 0");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_top","0.9 1 0");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_bottom","0.3 0.7 0");
		...
		else
		{
			...
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_top","1 1 0.2");
			mBoxText[GUI_TEXTOUTPUT]->setParameter("colour_bottom","1 0.8 0");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_top","1 1 0.2");
			mBoxText[GUI_TEXTINPUT]->setParameter("colour_bottom","1 0.8 0");
	...
	void party(MagixUnit *unit)
	{
		...
		if(mUnitManager->hasParty())
		{
			...
			mNetworkManager->sendInfo(INFO_PARTYINVITE,(OwnerToken)static_cast<MagixIndexedUnit*>(unit)->getIndex());
			mChatManager->message("Inviting "+unit->getUser()+" to join party.",CHAT_PARTY);
		}
		else
		{
			mNetworkManager->sendInfo(INFO_PARTYREQUEST,(OwnerToken)static_cast<MagixIndexedUnit*>(unit)->getIndex());
