...
public:
	...
	void processNewPlayer(Packet *p)
	{
		...
		{
			unsigned char tBodyMark, tHeadMark, tTailMark;
			char tColours[256];
	...
	void sendNewPlayer(const OwnerToken &target=OwnerToken(TOKEN_NULL))
	{
		...
		{
			unsigned char tBodyMark=0, tHeadMark=0, tTailMark=0;
	...
	void processActionFlags(Packet *p)
	{
		...
		if(tHasPrimary)
		{
			...
			else if(tPrimary==19)tUnit->doHumpingMaleCanineSlow(!tUnit->getIsHumpingMaleCanineSlow());
			else if(tPrimary==20)tUnit->doHumpingMaleCanine(!tUnit->getIsHumpingMaleCanine());
			else if(tPrimary==21)tUnit->doHumpingMaleCanineFast(!tUnit->getIsHumpingMaleCanineFast());
			else if(tPrimary==22)tUnit->doHumpingFemaleCanineSlow(!tUnit->getIsHumpingFemaleCanineSlow());
			else if(tPrimary==23)tUnit->doHumpingFemaleCanine(!tUnit->getIsHumpingFemaleCanine());
			else if(tPrimary==24)tUnit->doHumpingFemaleCanineFast(!tUnit->getIsHumpingFemaleCanineFast());
			else if(tPrimary==25)tUnit->doHumpingMaleFelineSlow(!tUnit->getIsHumpingMaleFelineSlow());
			else if(tPrimary==26)tUnit->doHumpingMaleFeline(!tUnit->getIsHumpingMaleFeline());
			else if(tPrimary==27)tUnit->doHumpingMaleFelineFast(!tUnit->getIsHumpingMaleFelineFast());
			else if(tPrimary==28)tUnit->doHumpingFemaleFelineSlow(!tUnit->getIsHumpingFemaleFelineSlow());
			else if(tPrimary==29)tUnit->doHumpingFemaleFeline(!tUnit->getIsHumpingFemaleFeline());
			else if(tPrimary==30)tUnit->doHumpingFemaleFelineFast(!tUnit->getIsHumpingFemaleFelineFast());
			else if(tPrimary==31)tUnit->doHumpingFemaleSnuggle1Slow(!tUnit->getIsHumpingFemaleSnuggle1Slow());
			else if(tPrimary==32)tUnit->doHumpingFemaleSnuggle1(!tUnit->getIsHumpingFemaleSnuggle1());
			else if(tPrimary==33)tUnit->doHumpingFemaleSnuggle1Fast(!tUnit->getIsHumpingFemaleSnuggle1Fast());
			else if(tPrimary==34)tUnit->doHumpingFemaleSnuggle2Slow(!tUnit->getIsHumpingFemaleSnuggle2Slow());
			else if(tPrimary==35)tUnit->doHumpingFemaleSnuggle2(!tUnit->getIsHumpingFemaleSnuggle2());
			else if(tPrimary==36)tUnit->doHumpingFemaleSnuggle2Fast(!tUnit->getIsHumpingFemaleSnuggle2Fast());
		}
		bool tHasSecondary;
	...
	void sendActionFlags(const OwnerToken &target=OwnerToken(TOKEN_NULL))
	{
		...
		else if(mUnitManager->getPlayer()->getIsHumpingMaleCanineSlow())tPrimary = 19;
		else if(mUnitManager->getPlayer()->getIsHumpingMaleCanine())tPrimary = 20;
		else if(mUnitManager->getPlayer()->getIsHumpingMaleCanineFast())tPrimary = 21;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleCanineSlow())tPrimary = 22;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleCanine())tPrimary = 23;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleCanineFast())tPrimary = 24;
		else if(mUnitManager->getPlayer()->getIsHumpingMaleFelineSlow())tPrimary = 25;
		else if(mUnitManager->getPlayer()->getIsHumpingMaleFeline())tPrimary = 26;
		else if(mUnitManager->getPlayer()->getIsHumpingMaleFelineFast())tPrimary = 27;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleFelineSlow())tPrimary = 28;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleFeline())tPrimary = 29;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleFelineFast())tPrimary = 30;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Slow())tPrimary = 31;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1())tPrimary = 32;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle1Fast())tPrimary = 33;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Slow())tPrimary = 34;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2())tPrimary = 35;
		else if(mUnitManager->getPlayer()->getIsHumpingFemaleSnuggle2Fast())tPrimary = 36;
	...
	void processWorldInfo(Packet *p)
	{
		...
		if(mUnitManager->getPlayer()->hasPet())
		{
			...
			const Vector3 tPosition = mUnitManager->getPlayer()->getPosition() + Vector3(Math::RangeRandom(-20,20),tC.flying?15:(Real)0,(Real)-25);
	...
	{
		const String tCaption = "<<(ADMIN)"+mUnitManager->getPlayer()->getUser()+">>"+caption;
		mChatManager->message(tCaption);
	...
	void processCritterInfo(Packet *p)
	{
		...
		if(tIsShrunk)
		{
			...
			if(tIsTrue)
			{
				...
				{
					const Real tScale = tCritter->getLength()>50?(Real)0.1: (1 - tCritter->getLength()*(Real)0.018);
			...
			else
			{
				...
				const Real tScale = (tCritter->getIsPet()&&tC.scale>1.5)?(Real)1.5:tC.scale;
				tCritter->getObjectNode()->setScale(tScale,tScale,tScale);
			}
			return;
		}
