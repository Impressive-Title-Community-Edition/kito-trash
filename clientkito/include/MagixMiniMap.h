...
protected:
	...
	vector<const unsigned short>::type pingUnitMarkers;
...
public:
	...
	{
		output = Vector2((Ogre::Real)((center.x-input.x)*0.00006*zoomRatio+0.06),(Ogre::Real)((center.y-input.y)*0.00008*zoomRatio+0.08));
	...
	void zoomIn()
	{
		...
		zoomRatio *= 2;
		mMapCone->setDimensions((Ogre::Real)0.15*zoomRatio, (Ogre::Real)0.2*zoomRatio);
		mMapCone->setPosition(mMap->getWidth()*(Ogre::Real)0.5 - mMapCone->getWidth()*(Ogre::Real)0.5,mMap->getHeight()*(Ogre::Real)0.5 - mMapCone->getHeight()*(Ogre::Real)0.5);
	}
	void zoomOut()
	{
