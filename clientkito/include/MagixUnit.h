...
public:
	...
	void createUnit(const unsigned short iID, SceneManager *sceneMgr, const String &bodyMesh, const String &headMesh, const String &maneMesh, const String &tailMesh, const String &wingMesh, const String &matName, const String &tuftMesh)
	{
		...
		/*Light* charLight = sceneMgr->createLight("charLight"+StringConverter::toString(iID));
		charLight->setType(Light::LT_POINT);
		charLight->setDiffuseColour(1, 1, 1);
		charLight->setSpecularColour(1,1,1);*/
...
//mBodyEnt->getParentSceneNode()->showBoundingBox(true);
		...
		emoteCount = 0.001;
		headTurnCount = 0;
		//mObjectNode->attachObject(charLight);
	}
	...
	void updateAnimation(const FrameEvent &evt, MagixExternalDefinitions *def)
	{
		...
		if(blinkFlag == 2)
		{
			...
			{
				mHeadEnt->getAnimationState("Blink")->addTime(evt.timeSinceLastFrame*(Ogre::Real)1.5);
				if(mHeadEnt->getAnimationState("Blink")->getTimePosition()>=eyelidState*mHeadEnt->getAnimationState("Blink")->getLength())
				{
		...
		else if(blinkFlag != 0)
		{
			...
			if(mHeadEnt->getAnimationState("Blink")->getTimePosition()>=eyelidState*mHeadEnt->getAnimationState("Blink")->getLength())
				mHeadEnt->getAnimationState("Blink")->addTime(blinkFlag*evt.timeSinceLastFrame*(Ogre::Real)1.5);
		...
		if(freeLook)
		{
			...
			if(mBodyEnt->getAnimationState(tOppTurn)->getEnabled())
			{
				...
				headTurnCount = mBodyEnt->getAnimationState(tOppTurn)->getTimePosition()/(mBodyEnt->getAnimationState(tOppTurn)->getLength()*(Ogre::Real)0.99);
			}
			if(headTurnCount>0)
			{
				...
				{
					mBodyEnt->getAnimationState(tOppTurn)->setTimePosition(headTurnCount*(mBodyEnt->getAnimationState(tOppTurn)->getLength()*(Ogre::Real)0.99));
					mHeadEnt->getAnimationState(tOppTurn)->setTimePosition(headTurnCount*(mHeadEnt->getAnimationState(tOppTurn)->getLength()*(Ogre::Real)0.99));
					if(mManeEnt)mManeEnt->getAnimationState(tOppTurn)->setTimePosition(headTurnCount*(mManeEnt->getAnimationState(tOppTurn)->getLength()*(Ogre::Real)0.99));
					if(mTuftEnt)mTuftEnt->getAnimationState(tOppTurn)->setTimePosition(headTurnCount*(mTuftEnt->getAnimationState(tOppTurn)->getLength()*(Ogre::Real)0.99));
				}
			}
			mBodyEnt->getAnimationState(tTurnAnim)->setEnabled(true);
			mBodyEnt->getAnimationState(tTurnAnim)->setTimePosition((1-headTurnCount)*tTurnRatio*(mBodyEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			//if(mHeadEnt->getAnimationState(tOppTurn)->getEnabled())mHeadEnt->getAnimationState(tOppTurn)->setEnabled(false);
			mHeadEnt->getAnimationState(tTurnAnim)->setEnabled(true);
			mHeadEnt->getAnimationState(tTurnAnim)->setTimePosition((1-headTurnCount)*tTurnRatio*(mHeadEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			if(mManeEnt)
			{
				//if(mManeEnt->getAnimationState(tOppTurn)->getEnabled())mManeEnt->getAnimationState(tOppTurn)->setEnabled(false);
				mManeEnt->getAnimationState(tTurnAnim)->setEnabled(true);
				mManeEnt->getAnimationState(tTurnAnim)->setTimePosition((1-headTurnCount)*tTurnRatio*(mManeEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			}
			if(mTuftEnt)
			{
				//if(mManeEnt->getAnimationState(tOppTurn)->getEnabled())mManeEnt->getAnimationState(tOppTurn)->setEnabled(false);
				mTuftEnt->getAnimationState(tTurnAnim)->setEnabled(true);
				mTuftEnt->getAnimationState(tTurnAnim)->setTimePosition((1-headTurnCount)*tTurnRatio*(mTuftEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			}
			...
			if(tTurnEyes>0)
			{
				...
				if(mHeadEnt->getAnimationState(tOppTurn)->getEnabled())mHeadEnt->getAnimationState(tOppTurn)->setEnabled(false);
				mHeadEnt->getAnimationState(tTurnAnim)->setEnabled(true);
				mHeadEnt->getAnimationState(tTurnAnim)->setTimePosition(tTurnEyes*(mHeadEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			}
			else
			{
			...
			mBodyEnt->getAnimationState(tTurnAnim)->setEnabled(true);
			mBodyEnt->getAnimationState(tTurnAnim)->setTimePosition(tTurnRatio*(mBodyEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			if(mHeadEnt->getAnimationState(tOppTurn)->getEnabled())mHeadEnt->getAnimationState(tOppTurn)->setEnabled(false);
			mHeadEnt->getAnimationState(tTurnAnim)->setEnabled(true);
			mHeadEnt->getAnimationState(tTurnAnim)->setTimePosition(tTurnRatio*(mHeadEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			if(mManeEnt)
			{
				if(mManeEnt->getAnimationState(tOppTurn)->getEnabled())mManeEnt->getAnimationState(tOppTurn)->setEnabled(false);
				mManeEnt->getAnimationState(tTurnAnim)->setEnabled(true);
				mManeEnt->getAnimationState(tTurnAnim)->setTimePosition(tTurnRatio*(mManeEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			}
			if(mTuftEnt)
			{
				if(mTuftEnt->getAnimationState(tOppTurn)->getEnabled())mTuftEnt->getAnimationState(tOppTurn)->setEnabled(false);
				mTuftEnt->getAnimationState(tTurnAnim)->setEnabled(true);
				mTuftEnt->getAnimationState(tTurnAnim)->setTimePosition(tTurnRatio*(mTuftEnt->getAnimationState(tTurnAnim)->getLength()*(Ogre::Real)0.99) );
			}
		...
		if(animCount>0)
		{
			...
			else
			{
				if(prevAnimBase!="")
				{
					...
					mBodyEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
					mHeadEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
					if(mManeEnt)mManeEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
					mTailEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
					if(mWingEnt)mWingEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
					if(mTuftEnt)mTuftEnt->getAnimationState(prevAnimBase)->setWeight(animCount/(Ogre::Real)0.1);
				}
				if(animBase!="")
				{
					mBodyEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
					mHeadEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
					if(mManeEnt)mManeEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
					mTailEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
					if(mWingEnt)mWingEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
					if(mTuftEnt)mTuftEnt->getAnimationState(animBase)->setWeight(((Ogre::Real)0.1-animCount)/(Ogre::Real)0.1);
				}
			}
		}
	}
		...
		if(animSecondCount>0)
		{
			...
			else
			{
				if(prevAnimSecond!="")
				{
					...
					mBodyEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
					mHeadEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
					if(mManeEnt)mManeEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
					mTailEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
					if(mWingEnt)mWingEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
					if(mTuftEnt)mTuftEnt->getAnimationState(prevAnimSecond)->setWeight(animSecondCount/(Ogre::Real)0.1);
				}
				if(animSecond!="")
				{
					mBodyEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
					mHeadEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
					if(mManeEnt)mManeEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
					mTailEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
					if(mWingEnt)mWingEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
					if(mTuftEnt)mTuftEnt->getAnimationState(animSecond)->setWeight(((Ogre::Real)0.1-animSecondCount)/(Ogre::Real)0.1);
				}
			}
		}
	}
	virtual void updateMovement(const FrameEvent &evt)
	{
		...
		if(tDistance>0)
		{
			...
			if(tDistance>( isCrouching?0.5:(isWalking?1:4)*Math::Sqr(tSpeedRatio) ))
			{
				...
				{
					tVect.y = (Ogre::Real)10 * (tYaw==Degree(180)?(Ogre::Real)-1:(Ogre::Real)1);
				}
				else if(tYaw==Degree(90)||tYaw==Degree(270))
				{
					tVect.x = (Ogre::Real)10 * (tYaw==Degree(270)?(Ogre::Real)-1:(Ogre::Real)1);
				}
				else
				{
	...
	void updateAction(const FrameEvent &evt, MagixExternalDefinitions *def)
	{
		...
		if(isSwimming)
		{
			speedMultiplier = (isMovingReverse()?(Ogre::Real)0.25:(Ogre::Real)1);
			changeAnimBase("Run", (Ogre::Real)0.5, animBase!="Run");
			return;
		}
		...
		if(antiGravity)
		{
			speedMultiplier = (Ogre::Real)1;
			changeAnimBase("Hover", (Ogre::Real)0.8, animBase!="Hover");
			return;
		}
		...
		{
			speedMultiplier = (Ogre::Real)1;
			if(!hasDoubleJumped || mBodyEnt->getAnimationState("Attack5")->hasEnded() || animBase!="Attack5")changeAnimBase("Run", (Ogre::Real)0.5, animBase!="Run");
		}
		else
		{
			...
			if(humpChange)
			{
				humpChange = false;
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				changeAnimBase(animBase, humpy);
			}

			//Run
			if(tSpeed>0 && !bReverse && !isWalking && !isCrouching)
			{
				Real tAnimSpeed = (evt.timeSinceLastFrame==0? (Ogre::Real)1.0 : tSpeed/ ((Ogre::Real)30000*evt.timeSinceLastFrame));
				if(tAnimSpeed>1.0)tAnimSpeed = 1.0;
				changeAnimBase("Run", (Ogre::Real)1.5 + tAnimSpeed, animBase!="Run");
			}
			//Crawl
			else if(tSpeed>0 && isCrouching)
			{
				changeAnimBase("Crawl", (Ogre::Real)1, animBase!="Crawl", bReverse);
			}
			//Walk
			else if(tSpeed>0 && (isWalking||bReverse))
			{
				changeAnimBase("Walk", (Ogre::Real)1.18, animBase!="Walk", bReverse);
			}
			//Sit transition
			else if(animBase=="SitTransition")
			{
				if(mBodyEnt->getAnimationState("SitTransition")->hasEnded())changeAnimBase("SitIdle", (Ogre::Real)0.1, true);
			}
			//Lay transition
			else if(animBase=="LayTransition")
			{
				if(mBodyEnt->getAnimationState("LayTransition")->hasEnded())changeAnimBase("LayIdle", (Ogre::Real)0.1, true);
			}
			//Hump transitions
			else if(animBase=="HC1Transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HC1Transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HC1", humpy, true);
			}
			else if(animBase=="HC2transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HC2transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HC2", humpy, true);
			}
			else if(animBase=="HF1transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HF1transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HF1", humpy, true);
			}
			else if(animBase=="HF2transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HF2transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HF2", humpy, true);
			}
			else if(animBase=="HH1transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HH1transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HH1", humpy, true);
			}
			else if(animBase=="HH2transition")
			{
				Ogre::Real humpy = 0.7;
				if(humpSpeed==1) humpy = 0.3;
				else if(humpSpeed==3) humpy = 1.3;
				if(mBodyEnt->getAnimationState("HH2transition")->hasEnded() && humpSpeed != 0)changeAnimBase("HH2", humpy, true);
			}
			//SideLay transition
			...
			//Stance idle
			else if(isStance && !isSitting() && !isLaying() && !isSideLaying() && !isPlopped() && !isRolledOver() && !isLeaning() && !isCurled() && !isDancing() && !isOneTimeAction() && !isHumpings())
			{
	...
	bool isHumpings()
	{
		return (animBase=="HC1Transition"||animBase=="HC1"||animBase=="HC2transition"||animBase=="HC2"
			||animBase=="HF1transition"||animBase=="HF1"||animBase=="HF2transition"||animBase=="HF2"
			||animBase=="HH1transition"||animBase=="HH1"||animBase=="HH2transition"||animBase=="HH2");
	}
	...
	void updateAutoTrack()
	{
		if(mAutoTrackTarget)
		{
			...
			if(!isAttacking() && (isPositionChanged() || mAutoTrackTarget->getPosition()!=lookTargetVector))
			{
				...
				{
					const Real tHeight = static_cast<MagixLiving*>(mAutoTrackTarget)->getHeight()*(Ogre::Real)0.5;
	...
	void changeAnimBase(const String &type, const Real &speed, bool resetTimePosition=false, bool reverseAnimation=false, bool loop=true)
	{
		if(type!="")
		{
			if(!mBodyEnt->getSkeleton()->hasAnimation(type)) return;
			if(!mHeadEnt->getSkeleton()->hasAnimation(type)) return;
			if(mManeEnt)if(!mManeEnt->getSkeleton()->hasAnimation(type)) return;
			if(!mTailEnt->getSkeleton()->hasAnimation(type)) return;
			if(mWingEnt)if(!mWingEnt->getSkeleton()->hasAnimation(type)) return;
			if(mTuftEnt)if(!mTuftEnt->getSkeleton()->hasAnimation(type)) return;
		}
	...
	void updateEmote(const FrameEvent &evt, MagixExternalDefinitions *def)
	{
		if(emoteCount>0)
		{
			...
			setEmoteState(prevEmoteMode,emoteCount/(Ogre::Real)EMOTE_TRANSITIONTIME,def);
			setEmoteState(emoteMode,((Ogre::Real)EMOTE_TRANSITIONTIME-emoteCount)/(Ogre::Real)EMOTE_TRANSITIONTIME,def);
		}
	}
	...
	const String vect4ToString(Vector4 vect, const unsigned short &tDeci)
	{
		...
		vect.x *= (Ogre::Real)deci; vect.x = (Ogre::Real)(int)vect.x; vect.x /= (Ogre::Real)deci;
		vect.y *= (Ogre::Real)deci; vect.y = (Ogre::Real)(int)vect.y; vect.y /= (Ogre::Real)deci;
		vect.z *= (Ogre::Real)deci; vect.z = (Ogre::Real)(int)vect.z; vect.z /= (Ogre::Real)deci;
		vect.w *= (Ogre::Real)deci; vect.w = (Ogre::Real)(int)vect.w; vect.w /= (Ogre::Real)deci;
	...
	void equip(SceneManager *sceneMgr, MagixExternalDefinitions *mDef, const String &meshName, const Vector3 &offset=Vector3::ZERO, const short &slot=-1, bool altAnim=false)
	{
		...
		mEquipEnt[slot]->getAnimationState((altAnim?"Equip2":"Equip"))->setLoop(true);
		mEquipEnt[slot]->getAnimationState((altAnim?"Equip2":"Equip"))->setTimePosition(0);
	...
	// humpings HC1
	bool getIsHumpingsMaleCanine()
	{
		return (animBase=="HC1Transition"||animBase=="HC1");
	}
	void doHumpingMaleCanineSlow(bool flag)
	{
		if(flag && !getIsHumpingsMaleCanine())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HC1Transition",0.7,animBase!="HC1Transition",false,false);
		}
		else if(!flag && getIsHumpingMaleCanineSlow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC1Transition",0.7,animBase!="HC1Transition",true,false);
		}
		else if(flag && getIsHumpingsMaleCanine())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingMaleCanineSlow()
	{
		return (humpSpeed==1) && (animBase=="HC1Transition"||animBase=="HC1");
	}
	void doHumpingMaleCanine(bool flag)
	{
		if(flag && !getIsHumpingsMaleCanine())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingMaleCanine())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC1Transition",0.7,animBase!="HC1Transition",true,false);
	...
	bool getIsHumpingMaleCanine()
	{
		return (humpSpeed==2) && (animBase=="HC1Transition"||animBase=="HC1");
	}
	void doHumpingMaleCanineFast(bool flag)
	{
		if(flag && !getIsHumpingsMaleCanine())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingMaleCanineFast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC1Transition",0.7,animBase!="HC1Transition",true,false);
	...
	bool getIsHumpingMaleCanineFast()
	{
		return (humpSpeed==3) && (animBase=="HC1Transition"||animBase=="HC1");
	}
	// humpings HF1
	bool getIsHumpingsMaleFeline()
	{
		return (animBase=="HF1transition"||animBase=="HF1");
	}
	void doHumpingMaleFelineSlow(bool flag)
	{
		if(flag && !getIsHumpingsMaleFeline())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HF1transition",0.7,animBase!="HF1transition",false,false);
		}
		else if(!flag && getIsHumpingMaleFelineSlow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF1transition",0.7,animBase!="HF1transition",true,false);
		}
		else if(flag && getIsHumpingsMaleFeline())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingMaleFelineSlow()
	{
		return (humpSpeed==1) && (animBase=="HF1transition"||animBase=="HF1");
	}
	void doHumpingMaleFeline(bool flag)
	{
		if(flag && !getIsHumpingsMaleFeline())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingMaleFeline())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF1transition",0.7,animBase!="HF1transition",true,false);
	...
	bool getIsHumpingMaleFeline()
	{
		return (humpSpeed==2) && (animBase=="HF1transition"||animBase=="HF1");
	}
	void doHumpingMaleFelineFast(bool flag)
	{
		if(flag && !getIsHumpingsMaleFeline())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingMaleFelineFast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF1transition",0.7,animBase!="HF1transition",true,false);
	...
	bool getIsHumpingMaleFelineFast()
	{
		return (humpSpeed==3) && (animBase=="HF1transition"||animBase=="HF1");
	}
	// humpings HC2
	bool getIsHumpingsFemaleCanine()
	{
		return (animBase=="HC2transition"||animBase=="HC2");
	}
	void doHumpingFemaleCanineSlow(bool flag)
	{
		if(flag && !getIsHumpingsFemaleCanine())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HC2transition",0.7,animBase!="HC2transition",false,false);
		}
		else if(!flag && getIsHumpingFemaleCanineSlow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC2transition",0.7,animBase!="HC2transition",true,false);
		}
		else if(flag && getIsHumpingsFemaleCanine())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingFemaleCanineSlow()
	{
		return (humpSpeed==1) && (animBase=="HC2transition"||animBase=="HC2");
	}
	void doHumpingFemaleCanine(bool flag)
	{
		if(flag && !getIsHumpingsFemaleCanine())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleCanine())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC2transition",0.7,animBase!="HC2transition",true,false);
	...
	bool getIsHumpingFemaleCanine()
	{
		return (humpSpeed==2) && (animBase=="HC2transition"||animBase=="HC2");
	}
	void doHumpingFemaleCanineFast(bool flag)
	{
		if(flag && !getIsHumpingsFemaleCanine())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleCanineFast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HC2transition",0.7,animBase!="HC2transition",true,false);
	...
	bool getIsHumpingFemaleCanineFast()
	{
		return (humpSpeed==3) && (animBase=="HC2transition"||animBase=="HC2");
	}
	// humpings HF2
	bool getIsHumpingsFemaleFeline()
	{
		return (animBase=="HF2transition"||animBase=="HF2");
	}
	void doHumpingFemaleFelineSlow(bool flag)
	{
		if(flag && !getIsHumpingsFemaleFeline())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HF2transition",0.7,animBase!="HF2transition",false,false);
		}
		else if(!flag && getIsHumpingFemaleFelineSlow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF2transition",0.7,animBase!="HF2transition",true,false);
		}
		else if(flag && getIsHumpingsFemaleFeline())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingFemaleFelineSlow()
	{
		return (humpSpeed==1) && (animBase=="HF2transition"||animBase=="HF2");
	}
	void doHumpingFemaleFeline(bool flag)
	{
		if(flag && !getIsHumpingsFemaleFeline())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleFeline())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF2transition",0.7,animBase!="HF2transition",true,false);
	...
	bool getIsHumpingFemaleFeline()
	{
		return (humpSpeed==2) && (animBase=="HF2transition"||animBase=="HF2");
	}
	void doHumpingFemaleFelineFast(bool flag)
	{
		if(flag && !getIsHumpingsFemaleFeline())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleFelineFast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HF2transition",0.7,animBase!="HF2transition",true,false);
	...
	bool getIsHumpingFemaleFelineFast()
	{
		return (humpSpeed==3) && (animBase=="HF2transition"||animBase=="HF2");
	}
	// humpings HH1
	bool getIsHumpingsFemaleSnuggle1()
	{
		return (animBase=="HH1transition"||animBase=="HH1");
	}
	void doHumpingFemaleSnuggle1Slow(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle1())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HH1transition",0.7,animBase!="HH1transition",false,false);
		}
		else if(!flag && getIsHumpingFemaleSnuggle1Slow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH1transition",0.7,animBase!="HH1transition",true,false);
		}
		else if(flag && getIsHumpingsFemaleSnuggle1())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingFemaleSnuggle1Slow()
	{
		return (humpSpeed==1) && (animBase=="HH1transition"||animBase=="HH1");
	}
	void doHumpingFemaleSnuggle1(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle1())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleSnuggle1())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH1transition",0.7,animBase!="HH1transition",true,false);
	...
	bool getIsHumpingFemaleSnuggle1()
	{
		return (humpSpeed==2) && (animBase=="HH1transition"||animBase=="HH1");
	}
	void doHumpingFemaleSnuggle1Fast(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle1())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleSnuggle1Fast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH1transition",0.7,animBase!="HH1transition",true,false);
	...
	bool getIsHumpingFemaleSnuggle1Fast()
	{
		return (humpSpeed==3) && (animBase=="HH1transition"||animBase=="HH1");
	}
	// humpings HH2
	bool getIsHumpingsFemaleSnuggle2()
	{
		return (animBase=="HH2transition"||animBase=="HH2");
	}
	void doHumpingFemaleSnuggle2Slow(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle2())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 1;
			changeAnimBase("HH2transition",0.7,animBase!="HH2transition",false,false);
		}
		else if(!flag && getIsHumpingFemaleSnuggle2Slow())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH2transition",0.7,animBase!="HH2transition",true,false);
		}
		else if(flag && getIsHumpingsFemaleSnuggle2())
		{
			humpChange = true;
			humpSpeed = 1;
		}
	}
	bool getIsHumpingFemaleSnuggle2Slow()
	{
		return (humpSpeed==1) && (animBase=="HH2transition"||animBase=="HH2");
	}
	void doHumpingFemaleSnuggle2(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle2())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleSnuggle2())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH2transition",0.7,animBase!="HH2transition",true,false);
	...
	bool getIsHumpingFemaleSnuggle2()
	{
		return (humpSpeed==2) && (animBase=="HH2transition"||animBase=="HH2");
	}
	void doHumpingFemaleSnuggle2Fast(bool flag)
	{
		if(flag && !getIsHumpingsFemaleSnuggle2())
		{
			if(isDisabled()||isAttacking())return;
		...
		else if(!flag && getIsHumpingFemaleSnuggle2Fast())
		{
			if(isDisabled()||isAttacking())return;
			humpSpeed = 0;
			changeAnimBase("HH2transition",0.7,animBase!="HH2transition",true,false);
	...
	bool getIsHumpingFemaleSnuggle2Fast()
	{
		return (humpSpeed==3) && (animBase=="HH2transition"||animBase=="HH2");
	}
	// back to normal
	void doHeadswing()
	{
	...
	void getMarkings(unsigned char &bodyID, unsigned char &headID, unsigned char &tailID)
	{
		bodyID = bodyMarkID;
		headID = headMarkID;
		tailID = tailMarkID;
	...
	{ // MouthA MouthE MouthM MouthO MouthF MouthI MouthL FaceNormal FaceSmile FaceOpenJaw
		if(!mHeadEnt->getSkeleton()->hasAnimation("MouthA") || !mHeadEnt->getSkeleton()->hasAnimation("MouthE") || !mHeadEnt->getSkeleton()->hasAnimation("MouthM") || 
			!mHeadEnt->getSkeleton()->hasAnimation("MouthO") || !mHeadEnt->getSkeleton()->hasAnimation("MouthF") || !mHeadEnt->getSkeleton()->hasAnimation("MouthI") || 
			!mHeadEnt->getSkeleton()->hasAnimation("MouthL") || !mHeadEnt->getSkeleton()->hasAnimation("FaceNormal") || !mHeadEnt->getSkeleton()->hasAnimation("FaceSmile") || 
			!mHeadEnt->getSkeleton()->hasAnimation("FaceOpenJaw")) return;
		if(lipSyncAnim!="")
		{
			//Unweigh emote
